...
public class TagRepository : ITagRepository
{
    ...
    public IReadOnlyCollection<TagDTO> ReadAll() => new ReadOnlyCollection<TagDTO>(_context.Tags.Select(t => new TagDTO(t.Id, t.Name)).ToList());
    ...
    public Response Delete(int tagId, bool force = false)
    {
        ...
        if(_context.Tasks.Where(t => t.Tags.Contains(entity)).Any()) return Conflict;
        _context.Tags.Remove(entity);
        return Deleted;
    }
